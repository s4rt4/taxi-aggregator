...
class CommissionServiceTest extends TestCase
{
    ...
    public function test_basic_tier_rate_is_20_percent(): void
    {
        $operator = $this->makeOperator('basic');
        $this->assertEquals(20.00, CommissionService::getRate($operator));
    }

    public function test_airport_approved_tier_rate_is_18_percent(): void
    {
        $operator = $this->makeOperator('airport_approved');
        $this->assertEquals(18.00, CommissionService::getRate($operator));
    }

    public function test_top_tier_rate_is_15_percent(): void
    {
        $operator = $this->makeOperator('top_tier');
        $this->assertEquals(15.00, CommissionService::getRate($operator));
    }

    public function test_unknown_tier_defaults_to_20_percent(): void
    {
    ...
    public function test_calculate_returns_correct_breakdown_for_basic_tier(): void
    {
        ...
        $this->assertEquals(20.00, $result['rate']);
        $this->assertEquals(20.00, $result['commission']);
        $this->assertEquals(80.00, $result['operator_earnings']);
    ...
    public function test_calculate_returns_correct_breakdown_for_airport_approved(): void
    {
        ...
        $this->assertEquals(9.00, $result['commission']);
        $this->assertEquals(41.00, $result['operator_earnings']);
    ...
    public function test_calculate_handles_decimal_amounts(): void
    {
        ...
        $this->assertEquals(5.63, $result['commission']);
        $this->assertEquals(31.87, $result['operator_earnings']);
    }
    ...
    {
        // Operator has basic tier (20%) but admin set custom rate of 8%
    ...
    public function test_tier_rate_used_when_commission_matches_tier(): void
    {
        ...
        $operator = $this->makeOperator('airport_approved', 18.00);
        $this->assertEquals(18.00, CommissionService::getRate($operator));
    }
    ...
    {
        $this->assertEquals(20.00, CommissionService::TIER_RATES['basic']);
        $this->assertEquals(18.00, CommissionService::TIER_RATES['airport_approved']);
        $this->assertEquals(15.00, CommissionService::TIER_RATES['top_tier']);
