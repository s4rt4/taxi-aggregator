...
<section class="py-5" style="background: linear-gradient(135deg, #1a2332 0%, #2d3e50 100%);">
    <div class="container text-center text-white">
        <h1 class="fw-bold mb-2">About {{ \App\Helpers\Settings::get('company_name', config('app.name')) }}</h1>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="text-muted">We started {{ \App\Helpers\Settings::get('company_name', config('app.name')) }} because booking a taxi in the UK was broken. Passengers had no way to compare prices without ringing multiple operators. Operators struggled to fill seats on quieter routes. There had to be a better way.</p>
